...
public class OrderControler {
	...
	/**
	 * 分析下getForObject 白话文翻译<br>
	 * 
	 * 1.截取url地址中的服务名称。<br>
	 * 2.使用服务名称(serviceId)去eureka注册中上获取实际调用的ip地址和端口号<br>
	 * 3.本地使用HttpClient进行远程调用<br>
	 * 看源码
	 */

	@RequestMapping("/orderToMemberAndMessage")
	public String orderToMember() {
		String url = "http://app-itmayiedu-member/sendMemberMessage";
