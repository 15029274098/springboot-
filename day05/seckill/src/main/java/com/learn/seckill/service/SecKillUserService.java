...
public class SecKillUserService {
    ...
    public SecKillUser selectOneUserByMobile(String username) {
        SecKillUser secKillUser = redisService.get(SeckillUserKey.getByMobile, "" + username, SecKillUser.class);
        if (secKillUser != null) {
            return secKillUser;
        }
        secKillUser = secKillUserMapper.selectOneUserByMobile(username);
        redisService.set(SeckillUserKey.getByMobile, "" + username, secKillUser);
        return secKillUser;
    }
