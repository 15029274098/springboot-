...
public class Md5Util {
    ...
    public static String inputPassToFormPass(String inputPass) {
        String str = getStringSalt(inputPass, SALT);
        return md5(str);
    }

    private static String getStringSalt(String inputPass, String salt) {
        return "" + salt.charAt(0) + salt.charAt(2) + inputPass + salt.charAt(5) + salt.charAt(4);
    }
    ...
    public static String formPassToDbPass(String formPass, String salt) {
        String str = getStringSalt(formPass, salt);
        return md5(str);
    }
