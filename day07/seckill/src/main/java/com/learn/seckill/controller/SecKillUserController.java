...
public class SecKillUserController {
    ...
    public void setUser() {
//        mqSender.sender("welcome to use rabbitmq");
//        mqSender.sendTopic("welcome to use rabbitmq");
        mqSender.sendFanout("welcome to use rabbitmq");
//        mqSender.sendHeader("welcome to use rabbitmq");
        redisService.set(SeckillUserKey.getByMobile, "id", "测试");
    }

    @GetMapping("/redis/get")
    public Result<String> getUser() {
        String value = redisService.get(SeckillUserKey.getByMobile, "id", String.class);
